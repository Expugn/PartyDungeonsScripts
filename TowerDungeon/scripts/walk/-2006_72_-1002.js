/**
 * WALK type script for BLOCK (-2006, 72, -1002)
 *
 * Tower Climb - Barrel 9.3
 *
 * @author      Expugn
 * @version     0.1
 * @type        WALK
...
function main() {
    ...
    const result = TowerClimb.check(dungeon.getTempVariable(var_names.tower_climb_answer), 9, 3, player.getLocation());
