/**
 * WALK type script for BLOCK (-2006, 72, -998)
 *
 * Tower Climb - Barrel 9.1
 *
 * @author      Expugn
 * @version     0.1
 * @type        WALK
...
function main() {
    ...
    const result = TowerClimb.check(dungeon.getTempVariable(var_names.tower_climb_answer), 9, 1, player.getLocation());
