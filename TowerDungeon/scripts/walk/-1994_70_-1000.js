/**
 * WALK type script for BLOCK (-1994, 70, -1000)
 *
 * Tower Climb - Barrel 8.2
 *
 * @author      Expugn
 * @version     0.1
 * @type        WALK
...
function main() {
    ...
    const result = TowerClimb.check(dungeon.getTempVariable(var_names.tower_climb_answer), 8, 2, player.getLocation());
