/**
 * WALK type script for BLOCK (-1998, 50, -1000)
 *
 * Tower Climb - Barrel 1.2
 *
 * @author      Expugn
 * @version     0.1
 * @type        WALK
...
function main() {
    ...
    const result = TowerClimb.check(dungeon.getTempVariable(var_names.tower_climb_answer), 1, 2, player.getLocation());
