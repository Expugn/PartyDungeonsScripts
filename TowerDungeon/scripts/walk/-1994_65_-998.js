/**
 * WALK type script for BLOCK (-1994, 65, -998)
 *
 * Tower Climb - Barrel 6.3
 *
 * @author      Expugn
 * @version     0.1
 * @type        WALK
...
function main() {
    ...
    const result = TowerClimb.check(dungeon.getTempVariable(var_names.tower_climb_answer), 6, 3, player.getLocation());
