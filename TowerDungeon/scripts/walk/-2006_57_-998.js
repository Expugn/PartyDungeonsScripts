/**
 * WALK type script for BLOCK (-2006, 57, -998)
 *
 * Tower Climb - Barrel 3.1
 *
 * @author      Expugn
 * @version     0.1
 * @type        WALK
...
function main() {
    ...
    const result = TowerClimb.check(dungeon.getTempVariable(var_names.tower_climb_answer), 3, 1, player.getLocation());
