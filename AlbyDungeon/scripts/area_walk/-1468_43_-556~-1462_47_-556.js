/**
 * AREAWALK type script for AREA (-1468, 43, -556) ~ (-1462, 47, -556)
 *
 * Room Three (South) Closed Door Bypass
 *
 * @author      Expugn
 * @version     0.1
 * @type        AREAWALK
 * @block       (-1468, 43, -556) ~ (-1462, 47, -556)
 *
...
function _enter() {
    ...
    if (dungeon.getTempVariable(var_names.room_three) && !dungeon.getTempVariable(var_names.key_three)) {
        ...
        ScheduleHandler(() => {
            ...
            const loc = new Location(player.getWorld(), -1464.5, 43, -569.5, 90, 0);
            player.teleport(loc);
        });
    }
}
