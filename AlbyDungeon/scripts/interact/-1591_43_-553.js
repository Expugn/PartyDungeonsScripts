    ...
    ScheduleHandler(() => {
        ...
        switch (dungeon.getTempVariable(var_names.difficulty)) {
            case difficulty.NORMAL:
                enemies.room_boss.normal();
                break;
            case difficulty.HARD:
                enemies.room_boss.hard();
                break;
            case difficulty.EXTREME:
                enemies.room_boss.extreme();
                break;
            default:
                enemies.room_boss.easy();
                break;
        }
        dungeon.messageParty(`${ChatColor.RED}Monsters ${ChatColor.GRAY}have spawned in the ${ChatColor.GOLD}Boss Room${ChatColor.GRAY}!`);
