/**
 * AREAWALK type script for AREA (-1431, 143, -1003) ~ (-1431, 147, -997)
 *
 * Key Door One Interaction
 *
 * @author      Expugn
 * @version     0.1
 * @type        AREAWALK
 * @block       (-1431, 143, -1003) ~ (-1431, 147, -997)
 *
...
function _enter() {
    ...
    const doorOpen = dungeon.getTempVariable(var_names.key_door_one);
    ...
    if (hasKey && !doorOpen) {
        ...
        dungeon.setTempVariable(var_names.key_door_one, true);
        ScheduleHandler(() => {
            doors.key_one_east.run_east(true);
        });
    }
