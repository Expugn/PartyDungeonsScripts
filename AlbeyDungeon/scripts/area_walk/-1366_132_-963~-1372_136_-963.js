/**
 * AREAWALK type script for AREA (-1366, 132, -963) ~ (-1372, 136, -963)
 *
 * Key Five Door Interaction
 *
 * @author      Expugn
 * @version     0.1
 * @type        AREAWALK
 * @block       (-1366, 132, -963) ~ (-1372, 136, -963)
 *
...
function _enter() {
    ...
    const doorOpen = dungeon.getTempVariable(var_names.key_door_five);
    ...
    if (hasKey && !doorOpen) {
        ...
        dungeon.setTempVariable(var_names.key_door_five, true);
        ScheduleHandler(() => {
            doors.key_five_south.run_south(true);
        });
    }
